...
import (
	...
	"fmt"
	"log/slog"
	"sso-service-grpc/internal/domain/models"
	"sso-service-grpc/internal/lib/jwt"
	"sso-service-grpc/internal/lib/logger/sl"
	"sso-service-grpc/internal/storage"
	"time"
...
func (a *Auth) IsAdmin(
	...
	if err != nil {
		...
		log.Error("failed to validate admin", sl.Err(err))
